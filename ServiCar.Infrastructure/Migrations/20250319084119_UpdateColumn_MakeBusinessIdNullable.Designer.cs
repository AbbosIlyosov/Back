...
namespace ServiCar.Infrastructure.Migrations
{
    ...
    [Migration("20250319084119_UpdateColumn_MakeBusinessIdNullable")]
    partial class UpdateColumn_MakeBusinessIdNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiCar.Domain.Models.Business", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ServiCar.Domain.Entities.Category", b =>
                {
                    b.HasOne("ServiCar.Domain.Models.Business", "Business")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("ServiCar.Domain.Models.Business", b =>
                {
                    b.HasOne("ServiCar.Domain.Entities.Image", "Image")
                        .WithOne("Business")
                        .HasForeignKey("ServiCar.Domain.Models.Business", "ImageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
